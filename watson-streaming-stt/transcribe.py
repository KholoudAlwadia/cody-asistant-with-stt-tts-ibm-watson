    ...
    if "results" in data:
        if data["results"][0]["final"]:
            ...
            with open('myaudio.txt', 'r') as f:
                ...
                responsee = assistant.message_stateless(
                    assistant_id='cbab29c1-ee01-49b1-ab5b-d30c00aa6079',
                    input={
                        'message_type': 'text',
                        'text': text
                    }
              ...
              #  print(json.dumps(responsee, indent=2))

                if responsee['output']['generic']:
                    if responsee['output']['generic'][0]['response_type'] == 'text':
                        t = responsee['output']['generic'][0]['text']
                        with open('./myaudio.mp3', 'wb') as audio_file:
                            res = tts.synthesize(t, accept='audio/mp3', voice='en-US_EmilyV3Voice').get_result()
